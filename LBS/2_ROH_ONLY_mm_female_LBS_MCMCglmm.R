...
female_LBS_df=read.table("PhD/Chapter_4_inbr_dep/female_LBS_df.txt", sep=",", header=T)#692 ids
...
female_LBS_model_ROH_ONLY=MCMCglmm(LBS~ trait+trait:ROHsum-1,
...
plot(female_LBS_model_ROH_ONLY)

summary(female_LBS_model_ROH_ONLY)

setwd("/Users/ahewett1/Documents")
save(female_LBS_df,female_LBS_model_ROH_ONLY, file="Rum_deer/ID_Chr_MolEcol_revised/Female_LBS_model_output_final_ROH_ONLY.RData")
